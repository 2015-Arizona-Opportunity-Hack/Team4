...
!function($) {
    ...
    Multiselect.prototype = {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    ...
                    if (options.length > this.numberDisplayed) {
						var key = this.nonSelectedText;
						if(key == 'None selected'){
							key = '';
						}
                        return options.length + ' ' + key + ' ' + this.nSelectedText + ' <b class="caret"></b>';
                    }
                    else {
                        var selected = '';
        ...
        buildContainer: function() {
            this.$container = $('<div class="btn-group" />');
            if(this.options.dropUp){
                this.$container = $('<div class="btn-group dropup" />');
            }
